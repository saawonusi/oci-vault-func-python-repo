...
def get_secret(ocid1.vaultsecret.oc1.uk-london-1.amaaaaaakujrcpia636am4piaqlzx3x6rhfsavauh5e27yopulvjfbngplca):
    ...
    try:
        ...
        secret_content = client.get_secret_bundle(ocid1.vaultsecret.oc1.uk-london-1.amaaaaaakujrcpia636am4piaqlzx3x6rhfsavauh5e27yopulvjfbngplca).data.secret_bundle_content.content.encode('utf-8')
